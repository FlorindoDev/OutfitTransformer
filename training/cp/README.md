...
Coprono early stopping, integrazione col trainer, default e catena degli stage.
...
| File | Copertura |
|---|---|
| `tests/training/cp/test_early_stopping.py` | patience, `min_delta`, direzioni min/max, trainer, CLI e catena degli stage |
